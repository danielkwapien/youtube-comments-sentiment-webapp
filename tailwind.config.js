...
module.exports = {
  ...
  safelist: [
    ...
    ...[
      '#90EE90', '#32CD32', '#9DC183', '#2E8B57', '#808000', '#00FF00', '#39FF14', '#50C878', 
      '#76B041', '#98FF98', '#00FF7F', '#4F7942', '#DC143C', '#FF2400', '#9B111E', '#800000', 
      '#800020', '#FF7F50', '#B22222', '#8B0000', '#FF6347', '#722F37', '#FFDB58', '#FFD700', 
      '#F4C430', '#FFFACD', '#FFBF00'
    ].flatMap(customColor => [
      `bg-[${customColor}]`,
      `border-[${customColor}]`,
